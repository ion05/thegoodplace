   ...
   return Scaffold(
      ...
      child: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          Text('Do check our Spotify playlist that might create that vibe for you',
              style: TextStyle(
                color: Colors.white,
              ...
              ElevatedButton(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text('Vibe', style: TextStyle(fontSize: 18.0, fontFamily: 'OpenSans-Condensed')),
                      SizedBox(
                        height: 2.0,
                        width: 10.0,
                      ),
              ...
              ElevatedButton(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text('Mood Booster', style: TextStyle(fontSize: 18.0, fontFamily: 'OpenSans-Condensed')),
                      SizedBox(
                        height: 2.0,
                        width: 10.0,
                      ),
