            ...
            ButtonBar(
              children: <Widget>[
                RaisedButton(
                  ...
                  onPressed: () {
                    launch(
                        'https://play.google.com/store/apps/details?id=com.twodboy.worldofgoofull&hl=en_IN&gl=US');
                  },
                ),
              ],
            ),
            ...
            ButtonBar(
              children: <Widget>[
                RaisedButton(
                  ...
                  onPressed: () {
                    launch(
                        'https://play.google.com/store/apps/details?id=air.com.amanitadesign.botanicula&hl=en_IN&gl=US');
                  },
                ),
              ],
            ),
      ...
      child: Card(
        ...
        child: Column(
          ...
          children: <Widget>[
            const ListTile(
              leading: Icon(Icons.games, size: 40),
              title: Text("Recettear: An Item Shop's Tale",
                  style: TextStyle(fontSize: 20.0)),
              subtitle: Text(
                  'Recettear: An Item Shop’s Tale is a role-playing game developed by Japanese dōjin maker EasyGameStation . ',
                  style: TextStyle(fontSize: 8.0)),
            ),
            ButtonBar(
              children: <Widget>[
